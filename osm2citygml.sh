...
echo '*********************************'
echo 'Rotating OBJ'
fme objflip.fmw --SourceDataset_OBJ $FOLDER/tile.obj --DestDataset_OBJ $FOLDER/rot_tile
...
echo cd $FOLDER
fme osm2citygml.fmw --SourceDataset_OBJ $FOLDER/3857_rot_tile.obj --DestDataset_CITYGML $FOLDER/file.gml
